...
export default function CurrentWeather({ weather, locationName }: CurrentWeatherProps) {
  ...
  return (
    <div className="weather-card rounded-3xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 text-center" data-testid="card-current-weather">
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center justify-center mb-2 sm:mb-4">
          <MapPin className="w-4 sm:w-5 h-4 sm:h-5 text-muted-foreground mr-2" />
          <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold" data-testid="text-location">
            {locationName}
          </h2>
        </div>
        <p className="text-muted-foreground text-base sm:text-lg px-2" data-testid="text-weather-description">
